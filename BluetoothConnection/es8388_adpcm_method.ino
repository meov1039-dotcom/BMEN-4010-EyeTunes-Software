...
void setup_ble() {
    ...
    // start advertising to iOS application
...
i2s_pin_config_t pin_config = {
  .mck_io_num = 0, .bck_io_num = 38, .ws_io_num = 37, .data_out_num = -1, .data_in_num = 35}; 
...
void setup() {
  ...
  es8388.inputSelect(IN2); // swap to IN1 for AUX setup 
